...
class ChessEngine:
    ...
    def notation(self, start, end):
        board_dict = {'a1': (7, 0), 'b1': (7, 1), 'c1': (7, 2), 'd1': (7, 3), 'e1': (7, 4), 'f1': (7, 5), 'g1': (7, 6),
                      'h1': (7, 7), 'i1': (0, 0), 'k1': (0, 0), 'l1': (0, 0),
                      'a2': (6, 0), 'b2': (6, 1), 'c2': (6, 2), 'd2': (6, 3), 'e2': (6, 4), 'f2': (6, 5), 'g2': (6, 6),
                      'h2': (6, 7), 'i2': (0, 0), 'k2': (0, 0), 'l2': (0, 0),
                      'a3': (5, 0), 'b3': (5, 1), 'c3': (5, 2), 'd3': (5, 3), 'e3': (5, 4), 'f3': (5, 5), 'g3': (5, 6),
                      'h3': (5, 7), 'i3': (0, 0), 'k3': (0, 0), 'l3': (0, 0),
                      'a4': (4, 0), 'b4': (4, 1), 'c4': (4, 2), 'd4': (4, 3), 'e4': (4, 4), 'f4': (4, 5), 'g4': (4, 6),
                      'h4': (4, 7), 'i4': (0, 0), 'k4': (0, 0), 'l4': (0, 0),
                      'a5': (3, 0), 'b5': (3, 1), 'c5': (3, 2), 'd5': (3, 3), 'e5': (3, 4), 'f5': (3, 5), 'g5': (3, 6),
                      'h5': (3, 7), 'i5': (0, 0), 'k5': (0, 0), 'l5': (0, 0),
                      'a6': (2, 0), 'b6': (2, 1), 'c6': (2, 2), 'd6': (2, 3), 'e6': (2, 4), 'f6': (2, 5), 'g6': (2, 6),
                      'h6': (2, 7), 'i6': (0, 0), 'k6': (0, 0), 'l6': (0, 0),
                      'a7': (1, 0), 'b7': (1, 1), 'c7': (1, 2), 'd7': (1, 3), 'e7': (1, 4), 'f7': (1, 5), 'g7': (1, 6),
                      'h7': (1, 7), 'i7': (0, 0), 'k7': (0, 0), 'l7': (0, 0),
                      'a8': (0, 0), 'b8': (0, 1), 'c8': (0, 2), 'd8': (0, 3), 'e8': (0, 4), 'f8': (0, 5), 'g8': (0, 6),
                      'h8': (1, 7), 'i8': (0, 0), 'k8': (0, 0), 'l8': (0, 0),
                      'a9': (0, 0), 'b9': (0, 1), 'c9': (0, 2), 'd9': (0, 3), 'e9': (0, 4), 'f9': (0, 5), 'g9': (0, 6),
                      'h9': (1, 7), 'i9': (0, 0), 'k9': (0, 0), 'l9': (0, 0),
                      'a10': (0, 0), 'b10': (0, 1), 'c10': (0, 2), 'd10': (0, 3), 'e10': (0, 4), 'f10': (0, 5),
                      'g10': (0, 6), 'h10': (1, 7), 'i10': (0, 0), 'k10': (0, 0), 'l10': (0, 0),
                      'a11': (0, 0), 'b11': (0, 1), 'c11': (0, 2), 'd11': (0, 3), 'e11': (0, 4), 'f11': (0, 5),
                      'g11': (0, 6), 'h11': (1, 7), 'i11': (0, 0), 'k11': (0, 0), 'l11': (0, 0),
                      }
        board_dict_1 = {}
...
def draw_pieces(screen, board):
    for i in range(11):
        for z in range(11):
            piece = board[i][z]
            if piece != '--':
                screen.blit(images[piece], pygame.Rect(z * SQ_SIZE, i * SQ_SIZE, SQ_SIZE,
                                                       SQ_SIZE))  # блиттинг (копирование битов) изображения в опр позицию
